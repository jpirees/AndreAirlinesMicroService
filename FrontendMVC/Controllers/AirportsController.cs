...
namespace FrontendMVC.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public AirportsController(FrontendMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await AirportAPIService.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,City,Country,Continent")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,City,Country,Continent")] Airport airport)
        {
            if (id != airport.Id)
            {
                return NotFound();
