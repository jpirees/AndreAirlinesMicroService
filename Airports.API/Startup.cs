...
namespace Airports.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(sp => new AirportRepository(config["ConnectionStrings:AirportsAPIContext"]));

            services.AddDbContext<AirportsAPIContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("AirportsAPIContext")));
